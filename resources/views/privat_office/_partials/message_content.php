...
<div class="sended_message">
	...
	<div class="message_cnt">
		<p class="message_theme">Вопрос по упражнению</p>
		<p class="message_text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In nec ex ut nisl volutpat vestibulum. Maecenas condimentum, ligula sit amet pellentesque mollis, justo enim sollicitudin purus, sit amet faucibus nunc diam euismod ex. Donec nibh mauris, commodo quis interdum nec, accumsan vel lorem. Aenean dapibus, neque id ullamcorper eleifend, nibh turpis dictum erat, at varius neque ex non nulla. Maecenas ultricies suscipit dolor nec finibus. 
		</p>
	</div>
</div>