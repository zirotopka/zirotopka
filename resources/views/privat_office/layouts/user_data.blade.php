<div class="user-data-content">
	...
	<div class="row">
		<div class="col-lg-3">
			...
			<p class="gray-text">{{$user->birthday}}</p>
		...
		<div class="col-lg-9">
			...
			<p class="gray-text">{{$user->surname.' '.$user->first_name.' '.$user->last_name}}</p>
			<p class="gray-text">{{$user->pasport_number.' '.$user->pasport_series.' '.$user->pasport_data_vidachi}}</p>
