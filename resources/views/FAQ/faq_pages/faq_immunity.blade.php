<div class="ruls_list hidden">
	<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
		...
		<div class="questions_block">
			<ul>
				<li>
					<a href="#" class="qw1">Как принять участие в проекте и что для этого нужно?</a>
				</li>
				<li>
					<a href="#" class="qw2">Что такое личный кабинет участника?</a>
				</li>
				<li>
					<a href="#" class="qw3">Что нужно делать, чтоб остаться в проекте?</a>
				</li>
				<li>
					<a href="#" class="qw4">Что такое обязательные и необязательные дни тренировок?</a>
				</li>
				<li>
					<a href="#" class="qw5">Что такое иммунитет в проекте?</a>
				</li>
				<li>
					<a href="#" class="qw6">Для чего необходимо оставаться в проекте?</a>
				</li>
				<li>
					<a href="#" class="qw7">В каких случаях личныйй кабинет участника может быть заблокирован?</a>
				</li>
				<li>
					<a href="#" class="qw8">Сколько обязательных дней можно пропустить?</a>
				</li>
				<li>
