                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 prg">
                        ...
                        <div>
                            <ul>
                                ...
                                <li>
                                    <a href="">Будут ли выходные дни в программах тренировок?</a>
                                    <div class="answ">
                                ...
                                <li>
                                    <a href="">Какие виды упражнений предусматриваются в программах?</a>
                                    <div class="answ">
                                ...
                                <li class="hidden">
                                    <a href="">Кто будет проверять отчеты по выполнению заданий?</a>
                                    <div class="answ">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ruls">
                        ...
                        <div>
                            <ul>
                                ...
                                <li class="hidden">
                                    <a href="">Что такое обязательные и необязательные дни тренировки?</a>
                                    <div class="answ">
                                ...
                                <li class="hidden">
                                    <a href="">В каких случаях личный кабинет участника может быть заблокирован?</a>
                                    <div class="answ">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 all">
                        ...
                        <div>
                            <ul>
                                ...
                                <li>
                                    <a href="">Как быстро участник получает деньги от бонусной программы?</a>
                                    <div class="answ">
