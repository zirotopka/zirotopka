...
<body>
	<header class="container-fluid" style="background-color: #282828; padding: 20px">

	</header>
	<div class="container" style="padding-top: 40px; padding-bottom: 40px">
		<h1 style="color: #da8836">АКТИВАЦИЯ АККАУНТА</h1>
		<p>Пожалуйста, подтвердите Ваш электронный адрес, <a href=""><b>нажмите сюда.</b></a></p>

		<p>Если у вас возникнут сложности с подтверждением, напишите сюда: <b>support@reformator.one</b></p>
	</div>
	<footer class="container-fluid" style="background-color: #282828; padding: 20px">
		<div class="container">
			<div class="hidden-xs hidden-sm col-md-6 col-lg-6">
				<img src="{{public_path().'/ico/REFORMATOR.svg'}}" alt="">
			</div>
