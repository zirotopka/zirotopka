...
<body>
	...
	<div class="container" style="padding: 60px; min-height: 300px; margin-bottom: 60px; background: url('{{env("APP_URL")."/image/mail/back_logo.png"}}') no-repeat; background-size: contain;background-position: bottom;">
		...
		<p style="font-size: 20px; margin: 20px 0px;">Ты получаешь это сообщение потому что зарегистрирован на платформе <a href="https://reformator.one/">www.reformator.one</a>, но до сих пор не начал свои занятия!</p>
		<p style="font-size: 20px; margin: 20px 0px;">
			Сейчас, когда новогодние праздники уже позади, самое время заняться своей физической формой. При этом, уже давно доказано, что поддерживать хорошую форму не означает ходить в фитнес-клуб и тратить деньги на тренера.
		</p>
		<p style="font-size: 20px; margin: 20px 0px;">
		...
		<p style="font-size: 20px; margin: 20px 0px;">
			Предлагаем Вам попробовать нашу новую программу!
			Как всегда, первые несколько дней бесплатные!
			Всем, кто зарегистрируется сегодня - приятный бонус в виде 500 ReforMoney (то есть, 500 рублей) на счете, которые Вы сможете приумножить и в любой момент вывести на свой кошелек!
		</p>
		<p style="font-size: 20px; margin: 20px 0px;">
