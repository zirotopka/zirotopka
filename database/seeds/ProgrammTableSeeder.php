...
class ProgrammTableSeeder extends Seeder
{
    ...
    {	
        ...
        $trainings = [
            ...
            ['slug' => 'r.one_lite','name' => 'R.ONE Lite','description' => 'Программа тренировок по лайт-цене для всех, кто хочет попробовать свои силы и не любит отправлять отчеты, а также кто хочет больше внимания уделить бонусной системе', 'days' => 28, 'tranings' => 8, 'day_off' => 10, 'tasks' => 11, 'cost' => 1500, 'status' => 1,'logo' => '/image/program/r.one_lite.png','lite' => 1],
        ];
