...
class ProgrammExerciveTableSeeder extends Seeder
{
    ...
    {	
        ...
        $exercive_array = [
    		...
    		['id' => 17, 'slug' => '', 'name' => 'Отжимания от пола', 'description' => 'Грудью касаемся пола, упращенный вариант упор с колен.', 'file_url' => '/video/trainings/ROneStart/17_otzimaniya_ot_pola.mp4', 'preview' => '/image/preview/отжимания-от-пола.jpg' ],
    		...
    		['id' => 23, 'slug' => '', 'name' => 'Стульчик', 'description' => 'Бедро параллельно полу, прямой угол в коленном суставе.', 'file_url' => '/video/trainings/ROneStart/23_stulchik.mp4', 'preview' => '/image/preview/стульчик-у-опоры.jpg' ],
