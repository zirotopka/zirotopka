...
{	
    ...
    {	
    	...
    	$programm->description = 'Программа предназначенная для новичков';
        $programm->cost = 2500;
...
Перед выполнением всех упражнений сразу или по отдельности рекомендуется сделать общую разминку, а после окончания выполнения тренировки – растяжку.', 'lead_time' => '','interest' => 0, 'difficult' => 1, 'stages' => [
				...
				['day' => 6, 'status' => 1, 'description' => 'Более глубокая проработка мышечной ткани и хороший жиросжигательный эффект!', 'lead_time' => '','interest' => 1, 'difficult' => 1, 'stages' => [
				...
				['day' => 7, 'status' => 1, 'description' => 'Легкое повышение нагрузки на организм, переход на следующую ступень', 'lead_time' => '','interest' => 0, 'difficult' => 1, 'stages' => [
				...
				['day' => 9, 'status' => 1, 'description' => 'Тренировка направлена на укрепление верхнего плечевого пояса и мышц пресса.', 'lead_time' => '','interest' => 1, 'difficult' => 1, 'stages' => [
				...
				['day' => 10, 'status' => 1, 'description' => '', 'lead_time' => '','interest' => 0, 'difficult' => 1, 'stages' => [
				...
				['day' => 13, 'status' => 1, 'description' => 'Сегодняшний день тренировки заметно покажет, насколько вы преуспели в своем развитии', 'lead_time' => '','interest' => 1, 'difficult' => 1, 'stages' => [
				...
				['day' => 15, 'status' => 1, 'description' => 'Глубокая проработка мышц ног', 'lead_time' => '','interest' => 1, 'difficult' => 1, 'stages' => [
				...
				['day' => 16, 'status' => 1, 'description' => 'Укрепление всех мышечных групп организма', 'lead_time' => '','interest' => 0, 'difficult' => 1, 'stages' => [
				...
				['day' => 18, 'status' => 1, 'description' => 'Поддержание мышечного тонуса ног', 'lead_time' => '','interest' => 0, 'difficult' => 1, 'stages' => [
				...
				['day' => 19, 'status' => 1, 'description' => 'Продолжаем развивать вашу двигательную активность', 'lead_time' => '','interest' => 1, 'difficult' => 1, 'stages' => [
				...
				['day' => 21, 'status' => 1, 'description' => 'Общая тренировка и хорошая проработка рук и мышц кора', 'lead_time' => '','interest' => 1, 'difficult' => 1, 'stages' => [
					['description' => 'Легкий бег', 'interest' => 1, 'time_exercive' => '15 минут', 'repeat_count' => '','status' => 1, 'exercise_id' => null],
				...
				['day' => 22, 'status' => 1, 'description' => 'Тренировка на выносливость', 'lead_time' => '','interest' => 0, 'difficult' => 1, 'stages' => [
				...
				['day' => 24, 'status' => 1, 'description' => 'Поддержание мышечного тонуса ног', 'lead_time' => '','interest' => 0, 'difficult' => 1, 'stages' => [
				...
				['day' => 25, 'status' => 1, 'description' => 'Хорошая проработка мышц пресса ног и рук', 'lead_time' => '','interest' => 1, 'difficult' => 1, 'stages' => [
				...
				['day' => 27, 'status' => 1, 'description' => 'Общая тренировка и хорошая проработка ног и мышц кора', 'lead_time' => '','interest' => 0, 'difficult' => 1, 'stages' => [
					['description' => 'Прыжки на скакалке', 'interest' => 1, 'time_exercive' => '', 'repeat_count' => '200 прыжков','status' => 1, 'exercise_id' => 27],
					['description' => 'Присед + выпад назад', 'interest' => 1, 'time_exercive' => '', 'repeat_count' => '3 подхода * 30 повторений', 'status' => 1, 'exercise_id' => 14],
					['description' => 'Скалолаз', 'interest' => 1, 'time_exercive' => '', 'repeat_count' => '3 подхода * 30 повторений', 'status' => 1, 'exercise_id' => 15],
